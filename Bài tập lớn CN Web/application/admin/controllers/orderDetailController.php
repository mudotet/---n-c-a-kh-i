    ...
    if (!empty($_POST)) {
      if (isset($_POST['status'])) {
        ...
        if ($old_status == 'hoàn thành') {
          echo '<script>alert("Order success, cannot change status!");</script>';
        } else {
        ...
        WHERE order_id = ' .
            ...
            echo '<script>alert("Update success!"); window.location.href = "orderDetailView.php?id=' .
              $id .
              '";</script>';
          } else {
            echo '<script>alert("Please select the correct status!");</script>';
          }
        }
      }
    }
